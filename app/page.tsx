      ...
      <div className="container mx-auto px-4 py-8 min-h-screen flex flex-col">
        ...
        <div className="text-center text-slate-800 mb-6 flex-shrink-0">
          <div className="flex justify-center items-center mb-4">
            <span className="text-4xl mr-3 sticker-glow">🌟</span>
            <h1 className="text-5xl font-bold gradient-text tracking-wide">AI Mood Journal</h1>
            <span className="text-4xl ml-3 sticker-glow">🌟</span>
          </div>
